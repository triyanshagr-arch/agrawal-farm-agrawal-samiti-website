        ...
        <html>
            <head>
                ...
                <style>
                    ...
                    .lh-header-title .lh-main-title { font-family: 'Yatra One', cursive; color: #8B0000; font-size: 38px; margin: 22px 0 0 0; line-height: 1.1; white-space: nowrap; }
                    ...
                    .lh-committee-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 0; position: relative; z-index: 2; margin-top: -42px; margin-bottom: 5px; border-top: 2px solid #8B0000; }

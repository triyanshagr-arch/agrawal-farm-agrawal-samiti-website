        ...
        <html>
            <head>
                ...
                <style>
                    ...
                    .lh-top-phrases { display: flex; justify-content: center; align-items: center; font-size: 13px; font-weight: bold; margin-bottom: -5px; position: relative; z-index: 2; }
                    ...
                    .lh-committee-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 0; position: relative; z-index: 2; margin-top: -15px; margin-bottom: 5px; border-top: 2px solid #8B0000; }

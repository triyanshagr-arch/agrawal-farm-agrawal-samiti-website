    ...
    if (bookingForm) {
        bookingForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzOrs-sG-R5lqSNhggWDxTwgGyN2JSKjDcGFgXZgpfo_0IJLcMME1EyzZRTWmHaQAuC/exec";
                fetch('https://script.google.com/macros/s/AKfycbzOrs-sG-R5lqSNhggWDxTwgGyN2JSKjDcGFgXZgpfo_0IJLcMME1EyzZRTWmHaQAuC/exec', {
                    method: 'POST',
        ...
        matrimonialForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                try {
                    ...
                    const response = await fetch('https://script.google.com/macros/s/AKfycbzOrs-sG-R5lqSNhggWDxTwgGyN2JSKjDcGFgXZgpfo_0IJLcMME1EyzZRTWmHaQAuC/exec', {
                        method: 'POST',
                        body: formDataObj
                    });
                    const result = await response.json();

    ...
    if (form) {
        form.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwP0zYZQp9ynZxFDulMpRIPVUC2K3pgxj2Pm3IGuH9u_Tu3Qique-iZPSvDQdFwoNeY/exec";
    ...
    if (bookingForm) {
        bookingForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwP0zYZQp9ynZxFDulMpRIPVUC2K3pgxj2Pm3IGuH9u_Tu3Qique-iZPSvDQdFwoNeY/exec";
                fetch('https://script.google.com/macros/s/AKfycbwP0zYZQp9ynZxFDulMpRIPVUC2K3pgxj2Pm3IGuH9u_Tu3Qique-iZPSvDQdFwoNeY/exec', {
                    method: 'POST',
        ...
        matrimonialForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                try {
                    ...
                    const response = await fetch('https://script.google.com/macros/s/AKfycbwP0zYZQp9ynZxFDulMpRIPVUC2K3pgxj2Pm3IGuH9u_Tu3Qique-iZPSvDQdFwoNeY/exec', {
                        method: 'POST',
                        body: formDataObj
                    });
                    const result = await response.json();

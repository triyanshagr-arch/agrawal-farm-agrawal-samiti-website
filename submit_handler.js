...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        form.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbx5HDH0rvV-PN637P35CASSSntkIRJOykAKndCrqLCtW--_SADRGF__qY5ePvpvMMlR/exec";
    ...
    if (bookingForm) {
        ...
        const GOOGLE_SCRIPT_URL_BASE = "https://script.google.com/macros/s/AKfycbx5HDH0rvV-PN637P35CASSSntkIRJOykAKndCrqLCtW--_SADRGF__qY5ePvpvMMlR/exec";
        ...
        bookingForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbx5HDH0rvV-PN637P35CASSSntkIRJOykAKndCrqLCtW--_SADRGF__qY5ePvpvMMlR/exec";
                fetch('https://script.google.com/macros/s/AKfycbx5HDH0rvV-PN637P35CASSSntkIRJOykAKndCrqLCtW--_SADRGF__qY5ePvpvMMlR/exec', {
                    method: 'POST',
        ...
        matrimonialForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                try {
                    ...
                    const response = await fetch('https://script.google.com/macros/s/AKfycbx5HDH0rvV-PN637P35CASSSntkIRJOykAKndCrqLCtW--_SADRGF__qY5ePvpvMMlR/exec', {
                        method: 'POST',
                        body: formDataObj
                    });
                    const result = await response.json();
